...
namespace DataLayer
{
    public class OrderContext : IDB<Basket, int>
    {
        ...
        public async Task DeleteAsync(int key)
        {
            try
            {
                Basket orderFromDb = await ReadAsync(key, false, false);
        ...
        public async Task<ICollection<Basket>> ReadAllAsync(bool useNavigationalProperties = false, bool isReadOnly = true)
        {
            try
            {
                IQueryable<Basket> query = dbContext.Orders;
        ...
        public async Task<Basket> ReadAsync(int key, bool useNavigationalProperties = false, bool isReadOnly = true)
        {
            try
            {
                IQueryable<Basket> query = dbContext.Orders;
        ...
        public async Task UpdateAsync(Basket item, bool useNavigationalProperties = false)
        {
            try
            {
                Basket orderFromDb = await ReadAsync(item.Id, true, false);
